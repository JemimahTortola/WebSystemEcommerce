...
class ProductSeeder extends Seeder
{
    public function run()
    {
        ...
        $products = [
            ...
            ['name' => '10 Blue Orchids - Exotic Elegance', 'slug' => '10-blue-orchids', 'description' => 'Exotic sophistication! 10 stunning blue orchids gracefully arranged in a beautiful glass vase. These rare, luxurious blooms represent love, beauty, and refinement. A unique gift for someone extraordinary!', 'price' => 2299, 'category' => 'vase-arrangements', 'image' => '/images/products/4881-1746687035440.webp'],
