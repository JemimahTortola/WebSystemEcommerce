                    ...
                    <div class="main-image">
                        @if($product->image)
                            <img src="{{ asset('storage/products/' . $product->image) }}" 
                                 ...
                                 loading="eager">
                        @else
                            <div class="placeholder-image" style="width: 100%; height: 100%; background: var(--light-gray); display: flex; align-items: center; justify-content: center; color: var(--text-muted); font-size: 0.9rem;">
                                Product Image
                            </div>
                        @endif
