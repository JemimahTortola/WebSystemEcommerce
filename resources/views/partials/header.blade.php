<header class="header">
    <div class="header-inner">
        ...
        <div class="header-right">
            ...
            @auth
            <div class="notification-wrapper" style="margin-right: 1rem;">
                <button class="header-icon" id="notificationBtn" title="Notifications" onclick="toggleNotificationDropdown()">
