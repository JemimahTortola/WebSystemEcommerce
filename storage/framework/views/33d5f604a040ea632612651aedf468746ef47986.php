    ...
    <div class="container">
        <div class="footer-content">
            ...
            <div class="footer-column">
                ...
                <ul>
                    <li><a href="<?php echo e(route('delivery-areas')); ?>">Delivery Areas</a></li>
        ...
        <div class="footer-bottom">
            <p>&copy; <?php echo e(date('Y')); ?> Flourista. All rights reserved.</p>
...
</footer><?php /**PATH C:\Users\jemim\Ecoms-apps\ecoms-florist\resources\views/partials/footer.blade.php ENDPATH**/ ?>